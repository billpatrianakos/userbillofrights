	...
	<section id="hero" class="row">
		<section class="row">
			<article class="six">
				...
				<p>
					<a class="button" href="">Know your rights!</a>
				</p>
			</article>
			<article class="six last">
	...
	<section id="ticker" class="container">
		<section class="row">
			<article class="twelve centered-text">
				<p>Do you run a web service that offers free accounts? <a href="">Get Listed!</a></p>
			</article>
		</section>
	</section>
	<section id="main-container" class="container">
		<section class="row">
			<article class="four">
				...
				<p>
					<a href="">Read your rights</a> or <a href="">See supporting services</a>
				</p>
			</article>
			<article class="four">
				...
				<p>
					<a href="">Read the rights</a> or <a href="">Be added as a supporter</a>
				</p>
			</article>
			<div class="one"></div>
			<aside class="three last">
				<?php get_sidebar(); ?>
			</aside>
		</section>
	</section>
